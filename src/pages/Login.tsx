    ...
    <div className="bg-background text-on-background antialiased selection:bg-primary-container selection:text-on-primary-container min-h-screen flex flex-col">
      ...
      <nav className="bg-surface text-on-surface w-full top-0 sticky border-b border-surface-variant shadow-sm shadow-slate-900/5 z-50 flex justify-between items-center px-6 py-3">
        <div className="flex items-center gap-4">
          <span className="font-headline-md text-headline-md italic font-semibold text-primary">
            Athenaeum
          </span>
        </div>
        <div className="hidden md:flex items-center gap-8">
          <a
            className="font-body-md text-body-md text-primary font-bold border-b-2 border-primary hover:bg-surface-container transition-colors px-2 py-1"
            href="#"
          >
            Home
          </a>
          <a
            className="font-body-md text-body-md text-on-surface-variant hover:bg-surface-container transition-colors px-2 py-1"
            href="#features"
          >
            Features
          </a>
        ...
        <div className="flex items-center gap-4">
          <button
            aria-label="Account"
            onClick={signIn}
            className="hover:bg-surface-container transition-colors p-2 rounded-full flex items-center justify-center group"
          >
      ...
      <main className="flex-grow flex flex-col items-center w-full">
        ...
        <section className="w-full max-w-[1200px] px-6 md:px-12 py-16 md:py-24 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          >
            <span className="font-label-caps text-label-caps text-secondary uppercase tracking-widest bg-secondary-container/20 px-3 py-1 rounded-sm">
              Your Personal Librarian
            </span>
            <h1 className="font-headline-xl text-headline-xl text-primary max-w-lg leading-tight">
              Curate your legacy, one page at a time.
            </h1>
            <p className="font-body-lg text-body-lg text-on-surface-variant max-w-md leading-relaxed">
              Athenaeum is the digital sanctuary for your physical books.
              Effortlessly catalog your collection, discover reading insights,
              and maintain the elegance of a private estate library in your
              pocket.
            </p>
        ...
        <section
          id="features"
          className="w-full bg-surface-container-low py-24 border-t border-surface-variant border-b"
        >
          <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col items-center">
            <div className="text-center max-w-2xl mb-16">
              <h2 className="font-headline-lg text-headline-lg text-primary mb-4">
                Cultivate your collection effortlessly
              </h2>
              <p className="font-body-md text-body-md text-on-surface-variant">
                Intelligent tools designed for the modern archivist, ensuring
                your library is as organized digitally as it is physically.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 w-full auto-rows-[300px]">
              ...
              <div className="md:col-span-8 bg-surface rounded-xl p-8 architectural-shadow border border-surface-variant flex flex-col sm:flex-row items-center gap-8 overflow-hidden relative">
                <div className="flex-1 flex flex-col items-start z-10">
                  ...
                  <h3 className="font-headline-md text-headline-md text-primary mb-2">
                    Instant ISBN Scanning
                  </h3>
                  <p className="font-body-md text-body-md text-on-surface-variant">
                    Add volumes to your catalog instantly. A single scan
                    retrieves high-resolution covers, publication details, and
                    full metadata.
                  </p>
                </div>
              ...
              <div className="md:col-span-4 bg-surface rounded-xl p-8 architectural-shadow border border-surface-variant flex flex-col items-start relative overflow-hidden group">
                ...
                <h3 className="font-headline-md text-headline-md text-primary mb-2 z-10">
                  Shelf Vision AI
                </h3>
                <p className="font-body-md text-body-md text-on-surface-variant z-10 mb-6">
                  Photograph an entire shelf. Our AI extracts titles and
                  authors, importing dozens of books in seconds.
                </p>
                <div className="mt-auto w-full flex justify-end z-10">
                  <button
                    onClick={signIn}
                    className="w-10 h-10 rounded-full border border-secondary flex items-center justify-center text-secondary group-hover:bg-secondary group-hover:text-on-secondary transition-colors"
                  >
              ...
              <div className="md:col-span-5 bg-surface rounded-xl p-8 architectural-shadow border border-surface-variant flex flex-col items-start relative">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant">
                  Sort by genre, reading status, or custom collections. A
                  minimalist interface inspired by ledger lines and fine
                  stationery.
                </p>
                {/* Mini Ledger View */}
              ...
              <div className="md:col-span-7 bg-primary text-on-primary rounded-xl p-8 architectural-shadow border border-primary-container flex flex-col sm:flex-row items-center gap-8 overflow-hidden relative">
                ...
                <div className="flex-1 flex flex-col items-start z-10">
                  ...
                  <p className="font-body-md text-body-md text-primary-fixed-dim">
                    Track your reading habits without the noise of social
                    networks. View pages read, genres explored, and reading
                    streaks in elegant, subdued charts.
                  </p>
                </div>
      ...
      <footer
        id="about"
        className="bg-surface py-8 border-t border-surface-variant mt-auto"
      >
        <div className="max-w-[1200px] mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6">
            <a
              className="font-body-md text-body-md text-on-surface-variant text-sm hover:text-primary transition-colors"
              href="#"
            >
              Privacy Policy
            </a>
