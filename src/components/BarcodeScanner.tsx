  ...
  const { ref } = useZxing({
    ...
    onError(error: Error | string) {
      if (!errorMsg) {
        ...
        if (msg.includes("video source") || msg.includes("Permission") || msg.includes("NotFound")) {
            setErrorMsg("Could not access camera. Please check permissions and ensure your device has a camera.");
        }
      }
    },
